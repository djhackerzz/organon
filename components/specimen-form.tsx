        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              required
              rows={3}
              placeholder="Brief anatomical description of the specimen..."
            />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              required
              rows={3}
              placeholder="Key physiological functions of this organ..."
            />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              required
              rows={3}
              placeholder="Important diseases, surgical points, exam relevance..."
            />
          </div>
          <div className="flex flex-col gap-2">
